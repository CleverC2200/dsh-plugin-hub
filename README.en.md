...
**8,000+ DeepSeek Harness (DSH) plugins indexed, 7,000+ hand-verified, in one community hub, updated daily. Browse, search, download and install by category — free, human-verified, traceable.**
...
<p align="center">
  <img src="https://api.dsh-plugin.org/images/releases/1-4-3/dsh-plugin-hub-market-en.png" alt="DSH Plugin Hub plugin market UI" width="840">
</p>
...
- Indexes **7,621** community plugins, **4,497** of which are hand-verified, curated and released every day by [dsh-plugin.org](https://dsh-plugin.org)
...
Questions, feature ideas or just want to talk plugins? Scan the QR code to join the DSH Plugin Hub user group — report issues, share suggestions, and improve the hub with the community. The QR code is refreshed periodically; this one is valid until 2026-09-18.

<p align="center">
  <img src="https://api.dsh-plugin.org/images/dsh-plugin-user-group-qr-2026-09-18.png?v=2" alt="DSH Plugin Hub user group QR code" width="250" height="250">
</p>
...
<p align="center">
  <img src="https://api.dsh-plugin.org/images/releases/1-4-3/dsh-plugin-hub-installed-en.png" alt="Installed plugins" width="400">
  <img src="https://api.dsh-plugin.org/images/releases/1-4-3/dsh-plugin-hub-custom-install-en.png" alt="Custom install" width="400">
</p>
...
<p align="center">
  <img src="https://api.dsh-plugin.org/images/releases/1-4-3/dsh-plugin-hub-settings-en.png" alt="Settings" width="400">
  <img src="https://api.dsh-plugin.org/images/releases/1-4-3/dsh-plugin-hub-system-logs-en.png" alt="System logs" width="400">
</p>
...
<p align="center">
  <img src="https://api.dsh-plugin.org/images/releases/1-4-3/dsh-plugin-hub-install-confirm-en.png" alt="Confirm install" width="400">
  <img src="https://api.dsh-plugin.org/images/releases/1-4-3/dsh-plugin-hub-uninstall-confirm-en.png" alt="Confirm uninstall" width="400">
</p>
...
<p align="center">
  <img src="https://api.dsh-plugin.org/images/releases/1-4-3/dsh-plugin-hub-update-confirm-en.png" alt="Confirm update" width="400">
  <img src="https://api.dsh-plugin.org/images/releases/1-4-3/dsh-plugin-hub-notifications-en.png" alt="Notifications" width="400">
</p>
...
The DSH Plugin Hub indexes **7,621** DeepSeek Harness plugins (DSH), **4,497** of which are hand-verified — updated daily, browse, search, download and install for free by category, fully sourced.
