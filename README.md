...
**DeepSeek Harness Plugin（DSH）插件市场与插件大全，收录 9,000+ 插件、人工精选 8,000+、每日更新，免费浏览、搜索并按分类发现、下载与安装 DSH 插件，人工验证、来源可溯。**
...
<p align="center">
  <img src="https://api.dsh-plugin.org/images/releases/1-4-3/dsh-plugin-hub-market-zh.png" alt="DSH Plugin Hub 插件市场界面" width="840">
</p>
...
- 收录 **9,365** 个社区插件，其中 **8,836** 已人工精选验证，由 [dsh-plugin.org](https://dsh-plugin.org) 每日收录、人工审核并发布
...
遇到使用问题、功能建议或想交流插件？扫码加入 DSH Plugin Hub 用户群，反馈问题、提交建议，与社区一起改进。群二维码定期更新，此码有效期至 2026-09-18。

<p align="center">
  <img src="https://api.dsh-plugin.org/images/dsh-plugin-user-group-qr-2026-09-18.png?v=2" alt="DSH Plugin Hub 用户群二维码" width="250" height="250">
</p>
...
<p align="center">
  <img src="https://api.dsh-plugin.org/images/releases/1-4-3/dsh-plugin-hub-installed-zh.png" alt="已安装插件列表" width="400">
  <img src="https://api.dsh-plugin.org/images/releases/1-4-3/dsh-plugin-hub-custom-install-zh.png" alt="自定义安装" width="400">
</p>
...
<p align="center">
  <img src="https://api.dsh-plugin.org/images/releases/1-4-3/dsh-plugin-hub-settings-zh.png" alt="设置" width="400">
  <img src="https://api.dsh-plugin.org/images/releases/1-4-3/dsh-plugin-hub-system-logs-zh.png" alt="系统日志" width="400">
</p>
...
<p align="center">
  <img src="https://api.dsh-plugin.org/images/releases/1-4-3/dsh-plugin-hub-install-confirm-zh.png" alt="确认安装" width="400">
  <img src="https://api.dsh-plugin.org/images/releases/1-4-3/dsh-plugin-hub-uninstall-confirm-zh.png" alt="确认卸载" width="400">
</p>
...
<p align="center">
  <img src="https://api.dsh-plugin.org/images/releases/1-4-3/dsh-plugin-hub-update-confirm-zh.png" alt="确认更新" width="400">
  <img src="https://api.dsh-plugin.org/images/releases/1-4-3/dsh-plugin-hub-notifications-zh.png" alt="通知中心" width="400">
</p>
...
DSH Plugin 插件市场收录 **9,365** 个 DeepSeek Harness Plugin（DSH）插件，其中 **8,836** 已人工精选验证，每日更新，免费按分类浏览、搜索、下载与安装，来源可溯。
